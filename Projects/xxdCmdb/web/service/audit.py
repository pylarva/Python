...
class Asset(BaseServiceList):
    def __init__(self):
        ...
        table_config = [
            ...
            },
            {
                ...
                'display': 1,
                'text': {
                    'content': "<i class='fa fa-exclamation-triangle' aria-hidden='true'></i><a href='#' onclick='cancle_apply({id})'> 审核 |</a>"
                               "<a href='#' onclick='cancle_apply({id})'> 拒绝 |</a>"
                               "<a href='#' onclick='cancle_apply({id})'> 详细</a>",
    ...
    def assets_condition(request):
        ...
        condition_dict = {"business_1": [], "business_2": [], "business_3": [], "host_ip__contains": [], "apply_user": []}
