...
class Asset(BaseServiceList):
    ...
    def fetch_assets(self, request):
        ...
        try:
            ...
            asset_count = models.BusinessOne.objects.filter(conditions).count()
            page_info = PageInfo(request.GET.get('pager', None), asset_count)
            asset_list = models.BusinessOne.objects.filter(conditions).extra(select=self.extra_select).values(
    ...
    def delete_assets(request):
        ...
        try:
            ...
            models.BusinessOne.objects.filter(id__in=id_list).delete()
    ...
    def put_assets(request):
        ...
        try:
            ...
            for row_dict in update_list:
                ...
                try:
                    models.BusinessOne.objects.filter(id=nid).update(**row_dict)
                except Exception as e:
