...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('repository', '0016_auto_20170410_1102'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_type_id', models.IntegerField(default=1, choices=[(1, b'\xe6\x9c\x8d\xe5\x8a\xa1\xe5\x99\xa8'), (2, b'\xe4\xba\xa4\xe6\x8d\xa2\xe6\x9c\xba'), (3, b'\xe9\x98\xb2\xe7\x81\xab\xe5\xa2\x99')])),
                ('device_status_id', models.IntegerField(default=1, choices=[(1, b'\xe4\xb8\x8a\xe6\x9e\xb6'), (2, b'\xe5\x9c\xa8\xe7\xba\xbf'), (3, b'\xe7\xa6\xbb\xe7\xba\xbf'), (4, b'\xe4\xb8\x8b\xe6\x9e\xb6')])),
                ('cabinet_num', models.CharField(max_length=30, null=True, verbose_name=b'\xe6\x9c\xba\xe6\x9f\x9c\xe5\x8f\xb7', blank=True)),
                ('cabinet_order', models.CharField(max_length=30, null=True, verbose_name=b'\xe6\x9c\xba\xe6\x9f\x9c\xe4\xb8\xad\xe5\xba\x8f\xe5\x8f\xb7', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=64, verbose_name=b'\xe4\xb8\x80\xe7\xba\xa7\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=64, verbose_name=b'\xe4\xb8\x89\xe7\xba\xa7\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(unique=True, max_length=64, verbose_name=b'\xe4\xba\x8c\xe7\xba\xa7\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf')),
                ('superior_business', models.ForeignKey(related_name='b1', verbose_name=b'\xe4\xb8\x80\xe7\xba\xa7\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf', to='repository.BusinessOne')),
            ],
            options={
        ...
        migrations.AlterModelOptions(
            name='asset',
            options={'verbose_name_plural': '\u8d44\u4ea7\u603b\u8868'},
        ),
        ...
        migrations.AddField(
            model_name='asset',
            name='host_item',
            field=models.IntegerField(default=1, verbose_name=((1, b'c1'), (1, b'c2'))),
        ),
        migrations.AddField(
            model_name='asset',
            name='host_name',
        ...
        migrations.AddField(
            model_name='asset',
            name='host_status',
            field=models.IntegerField(default=2, verbose_name=((1, b'\xe5\x9c\xa8\xe7\xba\xbf'), (2, b'\xe7\xa6\xbb\xe7\xba\xbf'))),
        ),
        migrations.AddField(
            model_name='asset',
            name='host_type',
            field=models.IntegerField(default=1, choices=[(1, b'\xe7\x89\xa9\xe7\x90\x86\xe6\x9c\x8d\xe5\x8a\xa1\xe5\x99\xa8'), (2, b'\xe8\x99\x9a\xe6\x8b\x9f\xe6\x9c\xba'), (3, b'\xe7\xbd\x91\xe7\xbb\x9c\xe8\xae\xbe\xe5\xa4\x87')]),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='b1', verbose_name=b'\xe4\xba\x8c\xe7\xba\xa7\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf', to='repository.BusinessTwo'),
        ),
        migrations.AddField(
            model_name='assets',
            name='business_unit',
        ...
        migrations.AddField(
            model_name='asset',
            name='business_1',
            field=models.ForeignKey(verbose_name=b'\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf1', blank=True, to='repository.BusinessOne', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_2',
            field=models.ForeignKey(verbose_name=b'\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf2', blank=True, to='repository.BusinessTwo', null=True),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_3',
            field=models.ForeignKey(verbose_name=b'\xe4\xb8\x9a\xe5\x8a\xa1\xe7\xba\xbf3', blank=True, to='repository.BusinessThree', null=True),
        ),
    ]
