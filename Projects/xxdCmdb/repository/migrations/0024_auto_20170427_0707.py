...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('repository', '0023_auto_20170426_1033'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.IntegerField(default=3, choices=[(1, b'root'), (2, b'admin'), (3, b'rd')])),
                ('status', models.IntegerField(default=1, choices=[(1, b'apply'), (2, b'pass'), (3, b'refuse')])),
