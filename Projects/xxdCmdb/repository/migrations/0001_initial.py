# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2018-06-05 06:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_item', models.IntegerField(choices=[(1, '已装机'), (2, '未装机'), (3, '故障机')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '在线'), (2, '空闲'), (3, '禁用')], default=2)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('switch_interface', models.CharField(blank=True, max_length=32, null=True)),
                ...
                ('gateway', models.GenericIPAddressField(blank=True, null=True)),
                ('status', models.IntegerField(choices=[(1, '待安装'), (2, '安装中'), (3, '已安装'), (4, '已失败')], default=1)),
            ],
            options={
