# -*- coding: utf-8 -*-
# Generated by Django 1.10.6 on 2018-03-19 08:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('physical_server_status', models.IntegerField(choices=[(1, '已装机'), (2, '未装机'), (3, '故障机')], default=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gateway', models.GenericIPAddressField(blank=True, null=True)),
                ('status', models.IntegerField(choices=[(1, '待安装'), (2, '安装中'), (3, '已安装'), (4, '已撤销')], default=1)),
            ],
            options={
