...
def xiaoqu_parse(response):
    ...
    # result['times'] = jpy('body > div.body-wrapper > div.basic-container > div.info-container > div.info-tb-container '
    #                       '> table > tbody > tr:nth-child(5) > td:nth-child(2)').text().split()
    print(result['times'])
